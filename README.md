...
| 编号 | 内容 |
|---|---|
| F1 | 装 Xcode 27（与现有 26.6 并存，不覆盖）。beta 不在 Mac App Store，在 [developer.apple.com/download](https://developer.apple.com/download/)，免费 Apple 账号即可，不需要付费会员。**不急**：只有手写识别需要它，其余全部工作都不依赖 |
